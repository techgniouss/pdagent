...
- **Живой удалённый рабочий стол**: стриминг рабочего стола в любой браузер через защищённый HTTPS-туннель — без проброса портов. Полное управление мышью и клавиатурой со смартфона, зум, режим трекпада, автоустановка cloudflared. См. [docs/REMOTE.md](docs/REMOTE.md).
...
| `SchedulerRegistry` | Хранение задач на диске, проверка каждые 5 с |
...
| Интеграция VS Code | ✅ | ❌ |
| Сборка APK | ✅ | ❌ |
| Живой удалённый рабочий стол (`/remote`) | ✅ | ❌ |
